 ...
 * Players in servers can either make games with {@link com.rem.otl.duo.messages.AddGameMessage}, or join games with {@link com.rem.otl.duo.messages.JoinGameMessage}.
 * When a server exits, it sends {@link com.rem.duo.messages.EndConnectionMessage}'s to all of its known players.
 * @author Geoffrey
 *
 */
public class AddPlayerMessage extends Message{
	...
	/**
	 * Initializes the {@link com.rem.duo.messages.Message} before it is send.
